...
void Library::add_user(std::string name, std::string email)
{
    int id = users.size() + 1;
...
bool Library::borrow_book(int user_id, int book_id, std::string borrow_date)
{
...
bool Library::return_book(int book_id)
{
...
void Library::list_borrows() const
{
...
int main()
{
    ...
    lib.return_book(1);
    lib.return_book(0);  // test
    lib.return_book(-1); // test
    lib.return_book(5);  // test
